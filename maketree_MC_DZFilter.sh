...
echo ""
./addBranch \
$TreeDir/TnPTree_Madgraph_Moriond17_dXYSIG_ADDED_WeightedBtoF_WeightedGtoH.root \
$TreeDir/SkimmedForDZFilter/TnPTree_Madgraph_Moriond17_dXYSIG_ADDED_WeightedBtoF_WeightedGtoH_tag_dXYSIG_ADDED.root \
